...
def show_obstruct():
    ...
    url = 'https://raw.githubusercontent.com/HayesAJ83/EGS/main/Data/sankey_Obs17.json'   #https://raw.githubusercontent.com/plotly/plotly.js/master/test/image/mocks/sankey_energy.json'
    response = urllib.request.urlopen(url)
    data = json.loads(response.read())
